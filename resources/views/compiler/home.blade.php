<x-compiler-layout>
    <div class="w-full">
        <div class="h-center">
            <div class="mt-10">
                <div class="h-center">
                    <div class="relative w-[200px] h-[200px] hover:scale-105 cursor-none">
        ...
        <div class="h-center">
            <div class="mt-12 mx-5 md:mx-16 lg:mx-32 bg-gray-800 text-slate-100 shadow px-5 md:px-10 lg:px-16 py-14 rounded-lg">
        ...
        <div class="py-5">
            <div class="mt-12 mx-5 md:mx-16 lg:mx-32">
